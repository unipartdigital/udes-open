...
RUN odoo-wrapper --without-demo=all -i \
    udes_stock,udes_mrp,udes_purchase,udes_report,udes_transport_management,udes_security,edi_sale,udes_sale_stock

# Module tests
#
CMD ["--test-enable", "-i", "udes_stock,udes_mrp,udes_purchase,udes_report,udes_transport_management,udes_security,edi_notifier,edi_sale_notifier,udes_sale_stock"]
