...
class StockPickingType(models.Model):
    ...
    u_post_assign_action = fields.Selection(selection_add=[get_selection(GroupByMoveLineKey)])
    u_post_validate_action = fields.Selection(selection_add=[get_selection(GroupByMoveLineKey)])
