...
| u_assign_refactor_constraint_value | Integer   | Constraint value used when refactoring post assign. Currently only used for the post assign actions: Maximum Quantity, Maximum Weight                     |
