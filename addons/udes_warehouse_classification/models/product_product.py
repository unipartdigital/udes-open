...
class ProductProduct(models.Model):
    ...
    def get_classification_messages_for_report(self, report_name):
        ...
        return self.product_tmpl_id.get_classification_messages_for_report(report_name)
    ...
    def get_printable_classification_names(self, separator="", order_key="name"):
        ...
        return self.product_tmpl_id.get_printable_classification_names(separator, order_key)
