...
class TestPrintStrategy(ActionPrintTest, metaclass=BuildTests):
    ...
    @classmethod
    def setUpClass(cls):
        logging.info('1. setUpClass for TestPrintStrategy')
        super().setUpClass()
        logging.info('2. setUpClass for TestPrintStrategy')
        ...
        logging.info('3. setUpClass for TestPrintStrategy')

    def setUp(self):
        logging.info('4. setUp for TestPrintStrategy')
        super().setUp()
        logging.info('5. setUp for TestPrintStrategy')

    def tearDown(self):
        logging.info('6. tearDown for TestPrintStrategy')
        super().tearDown()
        logging.info('7. tearDown for TestPrintStrategy')
