...
class ReserveStockPicking(models.TransientModel):
    ...
    def do_reserve(self):
        ...
        _logger.info(
            "User %r has requested stock reservation for pickings %r", self.env.uid, picking_ids
        )
    ...
    def do_unreserve(self):
        ...
        _logger.info(
            "User %r has requested stock unreservation for pickings %r", self.env.uid, picking_ids
        )
