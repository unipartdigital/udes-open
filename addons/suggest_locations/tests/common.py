...
class BaseUDES(common.SavepointCase):
    ...
    def _setup_locations(cls):
        ...
        (
            ...
            cls.test_goodsout_location_03,
            cls.test_goodsout_location_04,
        ) = cls.test_goodsout_locations

        cls.trailer_location = cls.stock_location.copy({"name": "TEST_OUT_TRAILER"})
